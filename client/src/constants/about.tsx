...
export function SubDescription() {
  ...
  return <span className="cursor-default"> 
    ...
    I work with game engines like <span className="text-teal-100/80 font-semibold">Unity, Roblox Studio, and Godot</span>, and I also do front-end web development with <span className="text-blue-100/80 font-semibold">React, TailwindCSS, ThreeJS, and HTML</span>. <br/>
