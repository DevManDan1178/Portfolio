var unityFramework = ( () => {
    ...
    return (function(unityFramework={}) {
            ...
            soundClip.createSourceNode = function() {
                ...
                Object.defineProperty(microphoneSource.playbackRate, "value", {
                    ...
                    set: function(v) {
                        ...
                        if (!soundClip.isRecording && microphoneSource.audioDataSourceNode.playbackRate.value !== v)
        ...
        function _SendStringMessage(messagePtr) {
        ...
        function _SignalPlayerLevelProgression(levelNumber) {
        ...
        function _SignalSceneChange(scenePtr) {
        ...
        function _navigator_gpu_request_adapter_async(options, adapterCallback, userData) {
            ...
            let gpu = navigator["gpu"]
              , opts = wgpuReadAdapterOptions(options);
            if (gpu) {
                let cb = adapter => {
        ...
        function _wgpu_adapter_request_device_async(adapter, descriptor, deviceCallback, userData) {
            ...
            adapter["requestDevice"](desc).then(_wgpuMuteJsExceptions(cb)).catch( () => {
                cb()
            }
            )
        }
        ...
        function _wgpu_command_encoder_begin_render_pass(commandEncoder, descriptor) {
            ...
            while (numColorAttachments--) {
                let v = HEAPU32[colorAttachmentsIdx]
                  , ds = HEAP32[colorAttachmentsIdx + 1];
        ...
        function wgpuReadConstants(constants, numConstants) {
            let c = {};
            while (numConstants--) {
                c[utf8(HEAPU32[constants >> 2])] = HEAPF64[constants + 8 >> 3];
                constants += 16
            }
            return c
        }
        ...
        function _wgpu_texture_create_view(texture, descriptor) {
            ...
            var descriptorIdx = descriptor >> 2
              , descriptorByteIdx = descriptor;
        ...
        var wasmImports = {
            "td": _GetJSLoadTimeInfo,
            "ud": _GetJSMemoryInfo,
            "Id": _JS_Accelerometer_IsRunning,
            "tb": _JS_Accelerometer_Start,
            "sb": _JS_Accelerometer_Stop,
            "sa": _JS_CallAsLongAsNoExceptionsSeen,
            "Nd": _JS_Cursor_SetImage,
            "ua": _JS_Cursor_SetShow,
            "ta": _JS_DOM_MapViewportCoordinateToElementLocalCoordinate,
            "s": _JS_DOM_UnityCanvasSelector,
            "gg": _JS_DownloadTextFile,
            "rd": _JS_Eval_OpenURL,
            "od": _JS_FileSystem_Initialize,
            "I": _JS_FileSystem_Sync,
            "sd": _JS_GetRandomBytes,
            "Kc": _JS_Get_WASM_Size,
            "Fd": _JS_GravitySensor_IsRunning,
            "pb": _JS_GravitySensor_Start,
            "ob": _JS_GravitySensor_Stop,
            "Ed": _JS_Gyroscope_IsRunning,
            "nb": _JS_Gyroscope_Start,
            "mb": _JS_Gyroscope_Stop,
            "Hc": _JS_Init_ContextMenuHandler,
            "xd": _JS_Init_CopyPaste,
            "Gd": _JS_LinearAccelerationSensor_IsRunning,
            "rb": _JS_LinearAccelerationSensor_Start,
            "qb": _JS_LinearAccelerationSensor_Stop,
            "Cc": _JS_Log_Dump,
            "Lc": _JS_Log_StackTrace,
            "cd": _JS_MobileKeybard_GetIgnoreBlurEvent,
            "J": _JS_MobileKeyboard_GetKeyboardStatus,
            "kb": _JS_MobileKeyboard_GetText,
            "zd": _JS_MobileKeyboard_GetTextSelection,
            "V": _JS_MobileKeyboard_Hide,
            "Ad": _JS_MobileKeyboard_SetCharacterLimit,
            "Bd": _JS_MobileKeyboard_SetText,
            "yd": _JS_MobileKeyboard_SetTextSelection,
            "lb": _JS_MobileKeyboard_Show,
            "Nb": _JS_Module_WebGLContextAttributes_PowerPreference,
            "Ud": _JS_Module_WebGLContextAttributes_PremultipliedAlpha,
            "Td": _JS_Module_WebGLContextAttributes_PreserveDrawingBuffer,
            "Jd": _JS_OrientationSensor_IsRunning,
            "vb": _JS_OrientationSensor_Start,
            "ub": _JS_OrientationSensor_Stop,
            "zb": _JS_RequestDeviceSensorPermissionsOnTouch,
            "Vc": _JS_RunQuitCallbacks,
            "Dd": _JS_ScreenOrientation_DeInit,
            "Ld": _JS_ScreenOrientation_Init,
            "H": _JS_ScreenOrientation_Lock,
            "qd": _JS_SetMainLoop,
            "sg": _JS_Sound_Create_Channel,
            "kg": _JS_Sound_Create_With_Buffer,
            "q": _JS_Sound_GetAudioBufferSampleRate,
            "j": _JS_Sound_GetAudioContextSampleRate,
            "L": _JS_Sound_GetLength,
            "ng": _JS_Sound_GetLoadState,
            "jg": _JS_Sound_Init,
            "oc": _JS_Sound_Load,
            "lg": _JS_Sound_Load_PCM,
            "Ka": _JS_Sound_Play,
            "La": _JS_Sound_ReleaseInstance,
            "Ab": _JS_Sound_ResumeIfNeeded,
            "og": _JS_Sound_Set3D,
            "hg": _JS_Sound_SetListenerOrientation,
            "ig": _JS_Sound_SetListenerPosition,
            "qc": _JS_Sound_SetLoop,
            "pc": _JS_Sound_SetLoopPoints,
            "ha": _JS_Sound_SetPaused,
            "rc": _JS_Sound_SetPitch,
            "rg": _JS_Sound_SetPosition,
            "pg": _JS_Sound_SetVolume,
            "M": _JS_Sound_Stop,
            "Tc": _JS_SystemInfo_GetAnimationFrameRate,
            "wd": _JS_SystemInfo_GetCanvasClientSize,
            ...
            "Od": _JS_SystemInfo_HasAstcHdr,
            "cb": _JS_SystemInfo_HasCursorLock,
            "fd": _JS_SystemInfo_HasFullscreen,
            "$": _JS_SystemInfo_HasWebGL,
            "jb": _JS_SystemInfo_HasWebGPU,
            "Yc": _JS_UnityEngineShouldQuit,
            "Fc": _JS_WebCamVideo_GetNativeHeight,
            "Gc": _JS_WebCamVideo_GetNativeWidth,
            "tg": _JS_WebCamVideo_GrabFrame,
            "h": _JS_WebGPU_SetCommandEncoder,
            "vg": _JS_WebGPU_Setup,
            "md": _JS_WebPlayer_FinishInitialization,
            "T": _SendStringMessage,
            "pa": _SignalLevelCleared,
            "oa": _SignalLevelLost,
            "na": _SignalLevelStarting,
            "ma": _SignalPauseToggled,
            "S": _SignalPlayerLevelProgression,
            "z": _SignalSceneChange,
            "Ie": ___syscall__newselect,
            "Kd": ___syscall_chmod,
            "mf": ___syscall_connect,
            "Md": ___syscall_faccessat,
            "o": ___syscall_fcntl64,
            "Wf": ___syscall_fstat64,
            "pd": ___syscall_getcwd,
            "Sc": ___syscall_getdents64,
            "He": ___syscall_ioctl,
            "wf": ___syscall_lstat64,
            "gd": ___syscall_mkdirat,
            "Gf": ___syscall_newfstatat,
            "nc": ___syscall_openat,
            "Oc": ___syscall_readlinkat,
            "Se": ___syscall_recvfrom,
            "Cd": ___syscall_renameat,
            "ad": ___syscall_rmdir,
            "Ze": ___syscall_sendto,
            "Qc": ___syscall_socket,
            "Pf": ___syscall_stat64,
            "Ic": ___syscall_statfs64,
            "Pc": ___syscall_symlink,
            "Jc": ___syscall_truncate64,
            "Hd": ___syscall_unlinkat,
            "vd": ___syscall_utimensat,
            ...
            "Rc": _emscripten_set_main_loop_timing,
            ...
            "Vd": _emscripten_webgl_init_context_attributes,
            ...
            "Sf": _glBindFramebuffer,
            "Tf": _glBindRenderbuffer,
            "be": _glBindSampler,
            "Uf": _glBindTexture,
            "Ce": _glBindVertexArray,
            "kc": _glBlendEquation,
            ...
            "Yd": _glClearBufferfi,
            "Xd": _glClearBufferfv,
            "Wd": _glClearBufferuiv,
            "Lf": _glClearColor,
            "Mf": _glClearDepthf,
            "Nf": _glClearStencil,
            "wa": _glClientWaitSync,
            "Ha": _glColorMask,
            "Jf": _glCompileShader,
            "Hf": _glCompressedTexImage2D,
            "ye": _glCompressedTexImage3D,
            "If": _glCompressedTexSubImage2D,
            "Be": _glCompressedTexSubImage3D,
            "le": _glCopyBufferSubData,
            "Ff": _glCopyTexImage2D,
            ...
            "$f": _glGetProgramInfoLog,
            "p": _glGetProgramiv,
            "Wb": _glGetQueryObjectuiv,
            "Ge": _glGetQueryiv,
            "lf": _glGetRenderbufferParameteriv,
            "af": _glGetShaderInfoLog,
            "_e": _glGetShaderPrecisionFormat,
            ...
            "ie": _glReadBuffer,
            "w": _glReadPixels,
            "We": _glRenderbufferStorage,
            "te": _glRenderbufferStorageMultisample,
            "ce": _glSamplerParameteri,
            "Ea": _glScissor,
            "Ue": _glShaderSource,
            "Ve": _glStencilFuncSeparate,
            "Re": _glStencilMask,
            "Te": _glStencilOpSeparate,
            "Pe": _glTexImage2D,
            "ze": _glTexImage3D,
            "Qe": _glTexParameterf,
            "Da": _glTexParameteri,
            ...
            "Ba": _glViewport,
            "bb": _js_html_utpWebSocketCreate,
            "U": _js_html_utpWebSocketDestroy,
            "_a": _js_html_utpWebSocketIsConnected,
            "$a": _js_html_utpWebSocketRecv,
            "ab": _js_html_utpWebSocketSend,
            "Cg": _navigator_gpu_get_preferred_canvas_format,
            "id": _navigator_gpu_request_adapter_async,
            "va": _strftime,
            "Mc": _strftime_l,
            "Xa": _wgpu_adapter_or_device_get_features,
            "Ya": _wgpu_adapter_or_device_get_limits,
            "hd": _wgpu_adapter_request_device_async,
            "Sa": _wgpu_buffer_get_mapped_range,
            "Va": _wgpu_buffer_map_async,
            "ja": _wgpu_buffer_read_mapped_range,
            "Ra": _wgpu_buffer_unmap,
            "Ag": _wgpu_canvas_context_configure,
            "ia": _wgpu_canvas_context_get_current_texture,
            "Dg": _wgpu_canvas_get_webgpu_context,
            "vc": _wgpu_command_encoder_begin_compute_pass,
            "P": _wgpu_command_encoder_begin_render_pass,
            "R": _wgpu_command_encoder_copy_buffer_to_buffer,
            "wc": _wgpu_command_encoder_copy_texture_to_buffer,
            "Ta": _wgpu_command_encoder_copy_texture_to_texture,
            "Fg": _wgpu_compute_pass_encoder_dispatch_workgroups,
            "Eg": _wgpu_compute_pass_encoder_dispatch_workgroups_indirect,
            "Q": _wgpu_device_create_bind_group,
            "n": _wgpu_device_create_bind_group_layout,
            "G": _wgpu_device_create_buffer,
            "g": _wgpu_device_create_command_encoder,
            "Wa": _wgpu_device_create_command_encoder_simple,
            "Gg": _wgpu_device_create_compute_pipeline,
            "v": _wgpu_device_create_pipeline_layout,
            "E": _wgpu_device_create_render_pipeline,
            "Dc": _wgpu_device_create_sampler,
            "t": _wgpu_device_create_shader_module,
            "ug": _wgpu_device_create_texture,
            "y": _wgpu_device_get_queue,
            "xc": _wgpu_device_pop_error_scope_async,
            "yc": _wgpu_device_push_error_scope,
            "Bg": _wgpu_device_set_uncapturederror_callback,
            "u": _wgpu_encoder_end,
            "la": _wgpu_encoder_finish,
            "D": _wgpu_encoder_pop_debug_group,
            "Oa": _wgpu_encoder_push_debug_group,
            "F": _wgpu_encoder_set_bind_group,
            "k": _wgpu_encoder_set_pipeline,
            "N": _wgpu_is_valid_object,
            "f": _wgpu_object_destroy,
            "e": _wgpu_object_set_label,
            "zg": _wgpu_queue_submit_multiple_and_destroy,
            "ka": _wgpu_queue_submit_one_and_destroy,
            "r": _wgpu_queue_write_buffer,
            "sc": _wgpu_queue_write_texture,
            "x": _wgpu_render_commands_mixin_draw,
            "tc": _wgpu_render_commands_mixin_draw_indexed,
            "Na": _wgpu_render_commands_mixin_draw_indexed_indirect,
            "Ma": _wgpu_render_commands_mixin_draw_indirect,
            "Bc": _wgpu_render_commands_mixin_set_index_buffer,
            "Ua": _wgpu_render_commands_mixin_set_vertex_buffer,
            "xg": _wgpu_render_pass_encoder_set_scissor_rect,
            "Ac": _wgpu_render_pass_encoder_set_stencil_reference,
            "wg": _wgpu_render_pass_encoder_set_viewport,
            "yg": _wgpu_texture_create_view,
            "Pa": _wgpu_texture_create_view_simple
        };
        var asm = createWasm();
        var ___wasm_call_ctors = function() {
            return (___wasm_call_ctors = Module["asm"]["Jg"]).apply(null, arguments)
        };
        var _GetFakemodTimeInSeconds = Module["_GetFakemodTimeInSeconds"] = function() {
            return (_GetFakemodTimeInSeconds = Module["_GetFakemodTimeInSeconds"] = Module["asm"]["Kg"]).apply(null, arguments)
        }
        ;
        var _ReleaseKeys = Module["_ReleaseKeys"] = function() {
            return (_ReleaseKeys = Module["_ReleaseKeys"] = Module["asm"]["Lg"]).apply(null, arguments)
        }
        ;
        var _GetCopyBufferAsCStr = Module["_GetCopyBufferAsCStr"] = function() {
            return (_GetCopyBufferAsCStr = Module["_GetCopyBufferAsCStr"] = Module["asm"]["Mg"]).apply(null, arguments)
        }
        ;
        var _getMetricsInfo = Module["_getMetricsInfo"] = function() {
            return (_getMetricsInfo = Module["_getMetricsInfo"] = Module["asm"]["Ng"]).apply(null, arguments)
        }
        ;
        var _SendMessageNumber = Module["_SendMessageNumber"] = function() {
            return (_SendMessageNumber = Module["_SendMessageNumber"] = Module["asm"]["Og"]).apply(null, arguments)
        }
        ;
        ...
        var _ConnectToProfiler = Module["_ConnectToProfiler"] = function() {
            return (_ConnectToProfiler = Module["_ConnectToProfiler"] = Module["asm"]["Sg"]).apply(null, arguments)
        }
        ;
        var _StopProfiling = Module["_StopProfiling"] = function() {
            return (_StopProfiling = Module["_StopProfiling"] = Module["asm"]["Tg"]).apply(null, arguments)
        }
        ;
        var _IsConnectedToProfiler = Module["_IsConnectedToProfiler"] = function() {
            return (_IsConnectedToProfiler = Module["_IsConnectedToProfiler"] = Module["asm"]["Ug"]).apply(null, arguments)
        }
        ;
        ...
        var _SendPasteEvent = Module["_SendPasteEvent"] = function() {
            return (_SendPasteEvent = Module["_SendPasteEvent"] = Module["asm"]["Wg"]).apply(null, arguments)
        }
        ;
        var ___errno_location = function() {
            return (___errno_location = Module["asm"]["Yg"]).apply(null, arguments)
        };
        var _htonl = function() {
            return (_htonl = Module["asm"]["htonl"]).apply(null, arguments)
        };
        var _htons = function() {
            return (_htons = Module["asm"]["Zg"]).apply(null, arguments)
        };
        var _ntohs = function() {
            return (_ntohs = Module["asm"]["_g"]).apply(null, arguments)
        };
        var _malloc = function() {
            return (_malloc = Module["asm"]["$g"]).apply(null, arguments)
        };
        var _free = function() {
            return (_free = Module["asm"]["ah"]).apply(null, arguments)
        };
        var _emscripten_builtin_memalign = function() {
            return (_emscripten_builtin_memalign = Module["asm"]["bh"]).apply(null, arguments)
        };
        var ___trap = function() {
            return (___trap = Module["asm"]["ch"]).apply(null, arguments)
        };
        var stackSave = function() {
            return (stackSave = Module["asm"]["dh"]).apply(null, arguments)
        };
        var stackRestore = function() {
            return (stackRestore = Module["asm"]["eh"]).apply(null, arguments)
        };
        var stackAlloc = function() {
            return (stackAlloc = Module["asm"]["fh"]).apply(null, arguments)
        };
