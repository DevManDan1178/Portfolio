function createUnityInstance(t, n, d) {
    function l(e, t) {
        if (!l.aborted && n.showBanner)
            return "error" == t && (l.aborted = !0),
            n.showBanner(e, t);
        switch (t) {
        case "error":
            console.error(e);
    ...
    var o, m = {
        ...
        printErr: function(e) {
            console.error(e),
            "string" == typeof e && -1 != e.indexOf("wasm streaming compile failed") && (-1 != e.toLowerCase().indexOf("mime") ? l('HTTP Response Header "Content-Type" configured incorrectly on the server for file ' + m.codeUrl + ' , should be "application/wasm". Startup time performance will suffer.', "warning") : l('WebAssembly streaming compilation failed! This can happen for example if "Content-Encoding" HTTP header is incorrectly enabled on the server for file ' + m.codeUrl + ", but the file is not pre-compressed on disk (or vice versa). Check the Network tab in browser Devtools to debug server header configuration.", "warning"))
        },
    ...
    var h, f, p, g, b, y, w, v, C, P = {
        ...
        ConnectToProfiler: function() {
            if (m.ConnectToProfiler)
                return m.ConnectToProfiler.apply(m, arguments);
            m.print("Failed to execute ConnectToProfiler: Player not loaded yet.")
        },
        StopProfiling: function() {
            if (m.StopProfiling)
                return m.StopProfiling.apply(m, arguments);
        ...
        GetMetricsInfo: function() {
            ...
            return {
                ...
                webAssemblyStartupTime: m.HEAPU32[l >> 2] - (m.webAssemblyTimeStart || 0),
                codeDownloadTime: m.HEAPU32[c >> 2],
        ...
        function o() {
            return void 0 === e ? a.arrayBuffer().then(function(e) {
                ...
                if (e.done) {
                    ...
                    if (h < l)
                        return c.slice(0, h);
                    for (var t = new Uint8Array(h), n = (t.set(c, 0),
                    f), r = 0; r < u.length; ++r)
                        t.set(u[r], n),
                        n += u[r].length;
                    return t
                }
                return h + e.value.length <= c.length ? (c.set(e.value, h),
    ...
    function(o, a) {
        var e, t, i = w.getInstance(), s = A("string" == typeof o ? o : o.url), d = {
            enabled: (e = s,
        ...
        d.enabled ? i.loadRequest(s).then(function(e) {
            ...
            l(o, a)) : fetch(s, {
                ...
                C(d.response, a.onProgress, a.enableStreamingDownload)) : l(o, a)
            }))) : l(o, a)
        }).catch(function(e) {
    ...
    function D() {
        var t, e, n, s, r, o = performance.now(), p = (new Promise(function(a, e) {
                ...
                if ("undefined" == typeof unityFramework || !unityFramework) {
                    ...
                    for (e in t) {
                        ...
                        if (m.frameworkUrl.endsWith("." + r[0]))
                            ...
                            "file:" == location.protocol ? void l(n + " Loading pre-compressed (brotli or gzip) content via a file:// URL without a web server is not supported by this browser. Please use a local development web server to host compressed Unity content, or use the Unity Build and Run option.", "error") : (n += ' This can happen if build compression was enabled but web server hosting the content was misconfigured to not serve the file with HTTP Response Header "Content-Encoding: ' + r[1] + '" present. Check browser Console and Devtools Network tab to debug.',
                    ...
                    l("Unable to parse " + m.frameworkUrl + "! The file is corrupt, or compression was misconfigured? (check Content-Encoding HTTP Response Header on web server)", "error")
                }
            ...
            i.onerror = function(e) {
                l("Unable to load file " + m.frameworkUrl + "! Check that the file exists on the remote server. (also check browser Console and Devtools Network tab to debug)", "error")
            }
            ,
        ...
        n(m[t], {
            ...
            "file:" == location.protocol ? l(t + ". Loading web pages via a file:// URL without a web server is not supported by this browser. Please use a local development web server to host Unity content, or use the Unity Build and Run option.", "error") : console.error(t)
        }));
        m.preRun.push(function() {
            ...
            a.then(function(t) {
                ...
                for (n + s > t.length && o("Invalid binary data file header! (pos=" + n + ", headerSize=" + s + ", file length=" + t.length + ")"); n < s; ) {
                    var d = r()
                      , l = r()
                      , c = (d + l > t.length && o("Invalid binary data file size! (offset=" + d + ", size=" + l + ", file length=" + t.length + ")"),
                    r())
                    ...
                    m.FS_createDataFile(u, null, t.subarray(d, d + l), !0, !0, !0)
                }
    ...
    return new Promise(function(e, t) {
        ...
        t(n)) : m.SystemInfo.hasWasm ? m.SystemInfo.hasWasm2023 ? (m.startupErrorHandler = t,
        d(0),
